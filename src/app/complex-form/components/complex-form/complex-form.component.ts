...
export class ComplexFormComponent implements OnInit {
  ...
  originCountry: string[]=["Cameroun", "Nigéria"];
  currentCountry: string[]=["Canada", "Etats-Unis"];
  ...
  private initFormControls(): void {
    ...
    this.originCtrl = this.formBuilder.control('Cameroun', Validators.required);
    this.currentCtrl = this.formBuilder.control('Canada', Validators.required);
  ...
  private setPhoneValidators(showPhoneCtrl: boolean){
    if (showPhoneCtrl){
      this.phoneCtrl.addValidators([Validators.required, Validators.minLength(9), Validators.maxLength(10)])
    }else{
